...
class GradientButtonStyle extends ButtonStyle {
  ...
  GradientButtonStyle copyWith(
    ...
    return GradientButtonStyle(
      backgroundGradient: backgroundGradient??gradient??this.backgroundGradient,
  ...
  static GradientButtonStyle? ler(GradientButtonStyle? a, GradientButtonStyle? b, double t) {
    if (identical(a, b)) {
      return a;
    }
    return GradientButtonStyle(
      textStyle: WidgetStateProperty.lerp<TextStyle?>(a?.textStyle, b?.textStyle, t, TextStyle.lerp),
      backgroundGradient: WidgetStateProperty.lerp<Gradient?>(a?.backgroundGradient, b?.backgroundGradient, t, Gradient.lerp),
      gradient: WidgetStateProperty.lerp<Gradient?>(a?.backgroundGradient, b?.backgroundGradient, t, Gradient.lerp),
  ...
  static WidgetStateProperty<BorderSide?>? _lerSides(WidgetStateProperty<BorderSide?>? a, WidgetStateProperty<BorderSide?>? b, double t) {
    if (a == null && b == null) {
      return null;
    }
  ...
  static WidgetStateProperty<Gradient?>? convertToGradient(
    ...
    return WidgetStateProperty.resolveWith<Gradient?>((Set<
        WidgetState> states) {
